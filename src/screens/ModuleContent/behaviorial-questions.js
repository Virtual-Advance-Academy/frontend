...
const BehaviorialQuestions = () => {
    ...
    return (
        <Container className={classes.container}>
            ...
            >
                <Grid item>
                    <Typography className={classes.contentDescription} variant="body1">
                        Companies are like a jigsaw puzzle, each piece is unique and they all come together to form one big picture
                        just as each employee brings their one-of-a-kind energy, personality and skillset to the table yet when they
                        all come together they are one harmonious organization.
                    </Typography>
                </Grid>

                <Grid item>
                    <Typography className={classes.contentDescription} variant="body1">
                        When an interviewer asks you behavioral interview questions,
            ...
            >
                <Grid item>
                    <Typography className={classes.contentDescription} variant="body1">
                        To prepare for behavioral interviews, Gayle Laakmann, created a resume grid where you can diagram your stories.
                    </Typography>
                </Grid>
                        ...
                        <CardActionArea>
                            ...
                            <CardContent>
                                ...
                                <Typography variant="body2" color="textSecondary" component="p">
                                    It is organized by central themes, such as leadership and influence, mistakes and failures, challenges, bugs, scaling, and so on.
                                    On the horizontal axis, you would put each of your experiences; internships, leadership roles, hourly-jobs, and so on.
                                    Don't feel pressured to fill out every single box, only the ones that are relevant and stand out for each of the experiences.
                                    Check out our adaptation of Gayle's chart by downloading your own copy below!
                                </Typography>
                            </CardContent>
                        </CardActionArea>
                        <CardActions>
                            <Button className={classes.downloadHere} size="small" color="primary">
                                Download Here
                            </Button>
                        </CardActions>
                    </Card>
                ...
                <Grid item>
                    <Typography className={classes.contentDescription} variant="body1">
                        When filling out the grid, it is important to have structured answers so recruiters can clearly understand the scenario,
                        the situation, the actions you took, along with the results.
                    </Typography>
                </Grid>
                    ...
                    <Card className={classes.root}>
                        <CardActionArea>
                            ...
                            <CardContent>
                                ...
                                <Typography variant="body2" color="textSecondary" component="p">
                                    Laakmann uses 'NSAR' to navigate each story in your resume grid. It is a useful structure to follow
                                    to ensure your stories are meaningful, to the point, clear, and showcase who you are.
                                </Typography>
                            </CardContent>
                        </CardActionArea>
                    </Card>
            ...
            <Grid container>
                <Typography className={classes.contentHeader} variant="h5" color="primary">Types of Questions</Typography>
            </Grid>
            <Grid container
                justify="center"
                spacing={2}
            >
                <Grid item>
                    <Typography className={classes.contentDescription} variant="body1">
                        There are a variety of categories that behavioral questions fall into and it is important to prepare for all
                        the majors ones just in case! Below we have broken up the categories and listed typical questions you might
                        see for them. Sourced from, Florida International University’s UPE Chapter, InternMakers, and Top Echelon.
                    </Typography>
                </Grid>
            </Grid>
            <Grid container>
            ...
            >
                <Grid item>
                    ...
                    <Typography className={classes.subDescription} variant="body1" gutterBottom>
                        Describe a time when you worked in a team where there were disagreements among the team.
                    </Typography>
                </Grid>
            </Grid>
            ...
            >
                <Grid item>
                    ...
                    <Typography className={classes.subDescription} variant="body1" gutterBottom>
                        Can you describe a time when you were in charge of a project? What would you do differently?
                    </Typography>

                    <Typography className={classes.subDescription} variant="body1" gutterBottom>
                        Can you tell me about a time when you had a difficult group to lead? What did you do to manage them?
                    </Typography>
            ...
            >
                <Grid item>
                    ...
                    <Typography className={classes.subDescription} variant="body1" gutterBottom>
                        How did you get your work assigned at your last position?
                    </Typography>
                </Grid>
            </Grid>
            ...
            >
                <Grid item>
                    ...
                    <Typography className={classes.subDescription} variant="body1" gutterBottom>
                        Can you describe a decision that you regretted? Why did you regret it?
                    </Typography>
                </Grid>
            </Grid>
            ...
            >
                <Grid item>
                    ...
                    <Typography className={classes.subDescription} variant="body1" gutterBottom>
                        Your friend is cheating on a test. He’s on his last warning. You’re the only one who knows he’s cheating. What do you do?
                    </Typography>
            ...
            >
                <Grid item>
                    ...
                    <Typography className={classes.subDescription} variant="body1" gutterBottom>
                        Why did you choose your college/university? Why led you to choose your major? Are you happy with your decision?
                    </Typography>
            ...
            >
                <Grid item>
                    ...
                    <Typography className={classes.subDescription} variant="body1" gutterBottom>
                        What makes Company X different from its competitors? For example, can you compare one of our products to one of our competitors products?
                    </Typography>
            ...
            <Grid container>
                <Typography className={classes.contentHeader} variant="h5" color="primary">Questions to ask your interviewer</Typography>
            </Grid>
            <Grid container
                justify="center"
                spacing={2}
            >
                <Grid item>
                    <Typography className={classes.contentDescription} variant="body1" gutterBottom>
                        When an interviewer asks at the end “do you have any questions for me?” the worst thing you can say is “no”.  
                        It shows you don’t have much interest in what they do at the company, the role, or the company in general. 
                    </Typography>
                    <Typography className={classes.contentDescription} variant="body1" gutterBottom>
                        Here are a couple of our personal favorite questions to ask them:
                    </Typography>
                </Grid>
            </Grid>
            <Grid container
